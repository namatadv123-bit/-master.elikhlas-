      ...
      <section className="relative z-10 pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto space-y-6 mb-16">
            ...
            <p className="text-lg text-slate-300">{t.tracksSub}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {tracks.map((track, idx) => (
              <div key={idx} className={`p-8 rounded-3xl bg-slate-900/80 backdrop-blur-xl border ${track.popular ? "border-2 border-amber-400 shadow-2xl shadow-amber-950/50" : "border-slate-800 hover:border-amber-500"} flex flex-col justify-between transition-all relative`}>
                {track.popular && <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-600 text-slate-950 text-xs font-black px-5 py-1 rounded-full shadow-md border border-amber-200">★ {t.mostPopular}</span>}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "Quran Learning Programs at El-Ikhlas Academy - Programs for kids and adults",
            numberOfItems: 3,
            itemListElement: [
              {
                "@type": "ListItem",
                ...
                item: {
                  ...
                  description: "Interactive online Quran program for children to learn Noorani Qaida and Quran"
                }
              },
              {
                "@type": "ListItem",
                ...
                item: {
                  "@type": "Course",
                  name: "Adults Quran Program",
                  description: "Comprehensive program for adults with memorization and Tajweed mastery"
                }
              },
              {
                "@type": "ListItem",
                ...
                item: {
                  ...
                  description: "Advanced program to obtain Quranic Ijazah with connected Sanad"
                }
              }
            ]
          })
