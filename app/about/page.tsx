    ...
    <div dir={isRtl ? "rtl" : "ltr"} className="min-h-screen bg-[#070b12] text-slate-100 font-sans selection:bg-amber-500 selection:text-slate-950 relative overflow-x-hidden">
      ...
      <section className="relative z-10 pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            <div>
              <span className="text-xs font-black uppercase tracking-widest text-amber-300 bg-amber-950/80 border border-amber-500/30 px-4 py-1.5 rounded-full">من نحن</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              {[
                { icon: <FaAward />, title: "إجازات معتمدة", desc: "معلمون مجازون بالسند المتصل إلى النبي ﷺ" },
                { icon: <FaUsers />, title: "+2000 طالب", desc: "طلاب نشطين من أكثر من 30 دولة حول العالم" },
                { icon: <FaGlobe />, title: "تعليم عالمي", desc: "دروس أونلاين تناسب جميع التوقيات واللغات" },
                { icon: <FaHeart />, title: "بيئة تعليمية آمنة", desc: "معلمات متخصصات للنساء والأطفال في بيئة مريحة" },
              ].map((item, idx) => (
      ...
      <section className="relative z-10 py-24 bg-slate-900/40 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
            <h2 className="text-3xl sm:text-5xl font-black text-white">رسالتنا</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: <FaBookOpen />, title: "نشر القرآن", desc: "نشر نور القرآن الكريم في كل بيت مسلم عبر العالم بأحدث الوسائل التقنية." },
              { icon: <FaAward />, title: "الجودة العالية", desc: "تقديم تعليم قرآني عالي الجودة على يد نخبة من المعلمين المجازين بالسند المتصل." },
              { icon: <FaUsers />, title: "المرونة", desc: "جعل تعليم القرآن متاحاً للجميع بغض النظر عن الموقع الجغرافي أو العمر." },
            ].map((item, idx) => (
      ...
      <section className="relative z-10 py-24 bg-slate-950/80 backdrop-blur-lg">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          <h2 className="text-3xl sm:text-5xl font-black text-white">ابدأ رحلتك معنا</h2>
          <p className="text-lg text-slate-300">احجز حصتك التجريبية المجانية الآن وتعرّف على مستواك</p>
          <a href={getWhatsappLink("السلام عليكم، أريد التسجيل في أكاديمية الإ独有的")} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center space-x-3 rtl:space-x-reverse px-10 py-5 rounded-2xl bg-gradient-to-r from-amber-500 via-amber-600 to-yellow-600 text-slate-950 font-black text-lg shadow-xl shadow-amber-950 border border-amber-300">
      ...
      <section className="relative z-10 py-16 bg-slate-900/40 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
            <h2 className="text-3xl sm:text-4xl font-black text-white">استكشف برامجنا</h2>
            <p className="text-slate-400">اختر المسار المناسب لك من بين برامجنا المتنوعة</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Link href="/tracks/kids" className="p-8 rounded-3xl bg-slate-900/70 backdrop-blur-xl border border-slate-800 hover:border-emerald-500/50 transition-all text-center">
              ...
              <h3 className="text-xl font-black text-white mb-3">مسار براعم القرآن</h3>
              <p className="text-sm text-slate-400">برنامج تعليمي تفاعلي مصمم خصيصاً للأطفال</p>
            </Link>
            <Link href="/tracks/adults" className="p-8 rounded-3xl bg-slate-900/70 backdrop-blur-xl border border-slate-800 hover:border-amber-500/50 transition-all text-center">
              ...
              <h3 className="text-xl font-black text-white mb-3">مسار الحفظ والتجويد</h3>
              <p className="text-sm text-slate-400">برنامج شامل لحفظ القرآن الكريم مع الإتقان</p>
            </Link>
            <Link href="/tracks/ijazah" className="p-8 rounded-3xl bg-slate-900/70 backdrop-blur-xl border border-slate-800 hover:border-amber-500/50 transition-all text-center">
              ...
              <h3 className="text-xl font-black text-white mb-3">مسار الإجازة</h3>
              <p className="text-sm text-slate-400">احصل على إجازة قرآنية بسند متصل إلى النبي ﷺ</p>
            </Link>
          </div>
        </div>
      </section>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: "أكاديمية الإخلاص لتعليم القرآن الكريم أونلاين. برامج متنوعة للأطفال والكبار مع معلمات ومعلمين مجazyين بالسند المتصل.",
            sameAs: [],
            contactPoint: {
              "@type": "ContactPoint",
